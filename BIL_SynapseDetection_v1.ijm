...
var spots_ch1_segmentation_method	= "Laplace";								//	spots segmentation method ch 1
...
var spots_ch2_segmentation_method	= "Laplace";								//	spots segmentation method ch 2
...
var spots_ch3_segmentation_method	= "Laplace";								//	spots segmentation method ch 3
...
var spots_ch4_segmentation_method	= "Laplace";								//	spots segmentation method ch 4
...
var spots_ch2_fixed_threshold_value	= 5;										//	fixed maximum threshold for spot segmentation (if auto doesn't work well); ch 2
...
macro "[I] Install Macro"{
	...
	run("Install...", "install=[/data/CBH/mverschuuren/ACAM/2021_BIL_MonicavandenBerg_Neurotransmitters/BIL_SynapseDetection_v1.ijm]");
}
...
macro "Analyse Single Image Action Tool - C888 T5f161"{
	...
	roiManager("reset");
	if(spots_ch1>0){
		args	= newArray(1,spots_ch1_segmentation_method,spots_ch1_threshold,spots_ch1_fixed_threshold_value,spots_ch1_filter_scale,spots_ch1_min_area,spots_ch1_max_area);
		snr 	= segmentSpots(id,args);
		if(snr>0){
	...
	if(spots_ch2>0){
		args	= newArray(2,spots_ch2_segmentation_method,spots_ch2_threshold,spots_ch2_fixed_threshold_value,spots_ch2_filter_scale,spots_ch2_min_area,spots_ch2_max_area);
		snr 	= segmentSpots(id,args);
		if(snr>0)
		{
	...
	if(spots_ch3>0){
		args	= newArray(3,spots_ch3_segmentation_method,spots_ch3_threshold,spots_ch3_fixed_threshold_value,spots_ch3_filter_scale,spots_ch3_min_area,spots_ch3_max_area);
		snr 	= segmentSpots(id,args);
		if(snr>0)
		{
	...
	if(spots_ch4>0){
		args	= newArray(4,spots_ch4_segmentation_method,spots_ch4_threshold,spots_ch4_fixed_threshold_value,spots_ch4_filter_scale,spots_ch4_min_area,spots_ch4_max_area);
		snr 	= segmentSpots(id,args);
		if(snr>0)
		{
...
function setup(){
	...
	if(spots_ch1){
		spots_ch1_segmentation_method		= Dialog.getChoice();		print("Spot Segmentation Method:",spots_ch1_segmentation_method);
		spots_ch1_threshold 				= Dialog.getChoice();		print("Spot autoThreshold:",spots_ch1_threshold);
		spots_ch1_fixed_threshold_value  	= Dialog.getNumber();		print("Fixed maximum threshold:",spots_ch1_fixed_threshold_value);
		spots_ch1_filter_scale 				= Dialog.getNumber();		print("Laplace spots ch1 filter_scale:",spots_ch1_filter_scale);
		spots_ch1_min_area	 				= Dialog.getNumber();		print("Min. spot size:", spots_ch1_min_area);
		spots_ch1_max_area 					= Dialog.getNumber();		print("Max. spot size:",spots_ch1_max_area);
	}
	if(spots_ch2){
		spots_ch2_segmentation_method		= Dialog.getChoice();		print("Spot Segmentation Method:",spots_ch2_segmentation_method);
		spots_ch2_threshold 				= Dialog.getChoice();		print("Spot autoThreshold:",spots_ch2_threshold);
		spots_ch2_fixed_threshold_value  	= Dialog.getNumber();		print("Fixed maximum threshold:",spots_ch2_fixed_threshold_value);
		spots_ch2_filter_scale 				= Dialog.getNumber();		print("Laplace spots ch2 filter_scale:",spots_ch2_filter_scale);
		spots_ch2_min_area	 				= Dialog.getNumber();		print("Min. spot size:", spots_ch2_min_area);
		spots_ch2_max_area 					= Dialog.getNumber();		print("Max. spot size:",spots_ch2_max_area);
	}
	if(spots_ch3){
		spots_ch3_segmentation_method		= Dialog.getChoice();		print("Spot Segmentation Method:",spots_ch3_segmentation_method);
		spots_ch3_threshold 				= Dialog.getChoice();		print("Spot autoThreshold:",spots_ch3_threshold);
		spots_ch3_fixed_threshold_value  	= Dialog.getNumber();		print("Fixed maximum threshold:",spots_ch3_fixed_threshold_value);
		spots_ch3_filter_scale 				= Dialog.getNumber();		print("Laplace spots ch3 filter_scale:",spots_ch3_filter_scale);
		spots_ch3_min_area	 				= Dialog.getNumber();		print("Min. spot size:", spots_ch3_min_area);
		spots_ch3_max_area 					= Dialog.getNumber();		print("Max. spot size:",spots_ch3_max_area);
	}
	if(spots_ch4){
		spots_ch4_segmentation_method		= Dialog.getChoice();		print("Spot Segmentation Method:",spots_ch4_segmentation_method);
		spots_ch4_threshold 				= Dialog.getChoice();		print("Spot autoThreshold:",spots_ch4_threshold);
		spots_ch4_fixed_threshold_value  	= Dialog.getNumber();		print("Fixed maximum threshold:",spots_ch4_fixed_threshold_value);
		spots_ch4_filter_scale 				= Dialog.getNumber();		print("Laplace spots ch4 filter_scale:",spots_ch4_filter_scale);
		spots_ch4_min_area	 				= Dialog.getNumber();		print("Min. spot size:", spots_ch4_min_area);
		spots_ch4_max_area 					= Dialog.getNumber();		print("Max. spot size:",spots_ch4_max_area);
	}
	print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
}
